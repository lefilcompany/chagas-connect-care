    ...
    <section className="relative overflow-hidden bg-gradient-soft">
      <div className="container grid items-center gap-12 py-20 lg:grid-cols-2 lg:py-28">
        <div className="space-y-7">
          ...
          <h1 className="font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-brand md:text-5xl lg:text-6xl">
            Transforme o cuidado com a <span className="relative inline-block">
              <span className="absolute inset-x-0 bottom-2 -z-10 h-3 bg-primary" />
              Doença de Chagas
            </span> com nossa plataforma digital
          </h1>
