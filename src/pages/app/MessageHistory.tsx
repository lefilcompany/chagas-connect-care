...
import {
  Search, RefreshCw, Check, CheckCheck, Clock, ArrowRight, ArrowLeft, X, History as HistoryIcon,
} from "lucide-react";
    ...
    <div className="space-y-6">
      <header className="flex flex-wrap md:flex-nowrap items-start md:items-center justify-between gap-4">
        <div className="min-w-0">
          <Link to="/app/mensagens" className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-brand mb-2">
            <ArrowLeft className="h-3 w-3" /> Voltar para Mensagens
          </Link>
